...
def PE_approx_52_42(pp,pos):
    ...
    for i in range(16):
        if i >=8:
            ...
            [pp_1st_stage[3][i],pp_1st_stage[2][i+1]]=compressors_52(pp[0][i],pp[1][i],pp[2][i],pp[3][i],pp[4][i],pos[0])
            [pp_1st_stage[1][i+1],pp_1st_stage[0][i]]=FA(pp[5][i],pp[6][i],pp[7][i])
        elif i==6:
            [pp_1st_stage[3][i],pp_1st_stage[2][i+1]]=compressors_52(pp[0][i],pp[1][i],pp[2][i],pp[3][i],pp[4][i],pos[1])
            [pp_1st_stage[0][i],pp_1st_stage[1][i+1]]=HA(pp[5][i],pp[6][i])
        elif i==5:
            [pp_1st_stage[3][i],pp_1st_stage[2][i+1]]=compressors_52(pp[0][i],pp[1][i],pp[2][i],pp[3][i],pp[4][i],pos[2])
            [pp_1st_stage[0][i],pp_1st_stage[1][i]]=[pp[5][i],0]
        elif i==4:
            [pp_1st_stage[3][i],pp_1st_stage[2][i+1]]=compressors_52(pp[0][i],pp[1][i],pp[2][i],pp[3][i],pp[4][i],pos[3])
    ...
    for i in range(16):
        if i>=8:
            ...
            [pp1[i],pp2[i+1]]=compressors_42(pp_1st_stage[3][i],pp_1st_stage[2][i],pp_1st_stage[1][i],pp_1st_stage[0][i],pos[5])
        elif i==6:
